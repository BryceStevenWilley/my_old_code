...
class ThreeByThreeReal extends RubikImagine{
    ...
    {   // Turns the left face (set as green default) clockwise.  
    ...
    {   // Turns the left face (set as green default) counterclockwise.
    ...
    {   // Turns the right face (set as blue default) clockwise, which is similar to 
    ...
    {   //Turns the right face (set as blue default) counterclockwise, which is similar
    ...
    {  // Turn the top face (set as the white default) clockwise. 
    ...
    { int y = 0;
        for(int i =0; i< 100; i++)
        {
            ...
            switch (y)
              {
                 case 1: this.leftClockwise(); break;
                 case 2: this.leftCounterClockwise(); break;
                 case 3: this.rightClockwise(); break;
                 case 4: this.rightCounterClockwise(); break;
                 case 5: this.topClockwise(); break;
                 case 6: this.topCounterClockwise(); break;
                 case 7: this.bottomClockwise(); break;
                 case 8: this.bottomCounterClockwise(); break;
                 case 9: this.frontClockwise(); break;
                 case 10: this.frontCounterClockwise(); break;
                 case 11: this.backClockwise(); break;
                 case 12: this.backCounterClockwise(); break;      
              }
        }
    }
}